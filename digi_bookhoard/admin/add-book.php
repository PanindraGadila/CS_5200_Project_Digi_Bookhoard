...
?>
    ...
    <head>
        ...
        <title>Digi-Bookhoard | Add Book</title>
                        ...
                        <div class="panel-body">
                            <form role="form" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="isbn" required="required" autocomplete="off" maxlength="7" placeholder="type numeric only 7 digit value" />
