...
?>
  ...
  <head>
    ...
    <title>Digi-Bookhoard | admin change password</title>
  ...
  <script type="text/javascript">
    function valid() {
      if (document.chngpwd.newpassword.value != document.chngpwd.confirmpassword.value) {
        ...
        document.getElementById("message").innerHTML = "**New Password and Confirm New Password Field do not match  !!";
