...
?>
  ...
  <head>
    ...
    <title>Digi-Bookhoard | Admin Dashboard</title>
  ...
  <body>
    ...
    <div class="content-wrapper">
      <div class="container">
        ...
        <div class="info">
        <h2>Note:</h2>
          <p><strong></strong> Above displayed Authors and Categories are not managed using this app, to add more authors or catagories then respective Database tables need to be modified.  </p>
        </div>
        <div class="row">
