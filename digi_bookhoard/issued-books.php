...
?>
    ...
    <head>
        ...
        <title>Digi-Bookhoard | Manage my Issued Books</title>
    ...
    <body>
        ...
        <div class="content-wrapper">
            <div class="container">
                <div class="row pad-botm">
                    <div class="col-md-12">
                        <h4 class="header-line">Manage My Issued Books</h4>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <!-- Advanced Tables -->
        ...
        <!-- Js files are placed here in end to load page faster and proper access  -->
